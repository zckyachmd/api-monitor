...
export function FlashToaster() {
  ...
  React.useEffect(() => {
    ...
    switch (type) {
      case 'success':
        toast.success(msg.title, options); break;
      case 'error':
        toast.error(msg.title, options); break;
      case 'info':
        toast.info(msg.title, options); break;
      case 'warning':
        toast.warning(msg.title, options); break;
      case 'loading':
        toast.loading(msg.title, options); break;
      default:
