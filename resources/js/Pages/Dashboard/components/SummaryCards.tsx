        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <div className="mt-2 h-10">
                        <Sparkline
                            data={series.up.map((d) => ({ value: d.value, time: d.bucket }))}
            ...
            <Card>
                <CardHeader className="group">
                    <div className="flex items-center justify-between gap-2">
                        ...
                        <Tooltip>
                            ...
                            <TooltipContent>
                                Monitors with checks in progress. Sparkline shows count over last
                                24h.
                            </TooltipContent>
                        </Tooltip>
                    </div>
                ...
                <CardContent>
                    ...
                    <div className="mt-2 h-10">
                        <Sparkline
                            data={series.pending.map((d) => ({ value: d.value, time: d.bucket }))}
                            colorVar={'#f59e0b'}
                        />
                    </div>
                </CardContent>
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <div className="mt-2 h-10">
                        <Sparkline
                            data={series.down.map((d) => ({ value: d.value, time: d.bucket }))}
